...
<form action="<?php echo base_url().'admin/update_anggota' ?>" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<select name="gender" class="form-control">
			<option <?php if($a->gender == "Laki-laki"){echo "selected='select'";} echo $a->gender;?> value="Laki-laki">Laki-laki</option>
			<option <?php if($a->gender == "Perempuan"){echo "selected='select'";} echo $a->gender;?> value="Perempuan">Perempuan</option>
		</select>
